...
public class DummyControllerTest {
	...
	@Autowired //DummyControllerTest 가 메모리에 뜰때 같이뜸 //의존성 주입(DI)
...
//		userRepository.save(user); 
	...
	public User detail(@PathVariable int id) {
		// user/4 찾으면 내가 데이터베이스에서 못찾아오게 되면 user가 null이 될 것이 아닌가
		// 그럼 return null 이 리턴이 됨 그럼 프로그램이 문제가 생기지 않을까?
		// Optional로 너의 User 객체를 감싸서 가져올테니 null인지 아닌지 판단해서 return ㄱㄱ
